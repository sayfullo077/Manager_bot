...
class Task(models.Model):
    ...
    employees = models.ManyToManyField(Employee, blank=True, related_name='tasks_assigned')
    accepted = models.ManyToManyField(Employee, blank=True, related_name='tasks_accepted')
    image = models.ImageField(upload_to='images/', blank=True, validators=[
        validators.FileExtensionValidator(allowed_extensions=['ico','png','jpeg','jpg'], 
            message="Enter an image in the format below('ico','png','jpeg','jpg')")
        ])
...
class CompanyInfo(models.Model):
    text = models.CharField(max_length=955, null=True, blank="True")
    video = models.FileField(upload_to="videoes", blank=True)
    image = models.ImageField(upload_to='images/', blank=True, validators=[
        validators.FileExtensionValidator(allowed_extensions=['ico','png','jpeg','jpg'], 
            message="Enter an image in the format below('ico','png','jpeg','jpg')")
        ])
